window.addEventListener("load", function () {
  ...
  class Angler1 extends Enemy {
    constructor(game) {
      ...
      // paste the scores and lives here because they need
      // to be different for every class
      this.lives = 2;
  ...
  // this is the second enemy type, we would like to have functionality
  // that says 50% of the time, make an emeny angler 1 else 2
  ...
  class LuckyFish extends Enemy {
    constructor(game) {
      ...
      this.lives = 3;
      this.score = 15;
      // using this we can check what the player collided with
      this.type = "lucky";
  ...
  class Game {
    ...
    addEnemy() {
      // randomly create different anglers
